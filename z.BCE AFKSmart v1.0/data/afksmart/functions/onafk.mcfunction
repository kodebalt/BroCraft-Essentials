execute if score @s afksmart.timer = #timeToAFKInTicks afksmart.config as @s run tellraw @s ["",{"text":"You are ","color":"gray"},{"text":"AFK","color":"gray","bold":true}]
# setup custom colors for 'You'
execute if score @s afksmart.timer = #timeToAFKInTicks afksmart.config at @s run tellraw @a[distance=0.001..] ["",{"selector":"@s"},{"text":" is ","color":"gray"},{"text":"AFK","color":"gray","bold":true}]
